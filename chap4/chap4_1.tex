...
\begin{equation}
  \epsilon_{kin} = \frac{ \rm{The~number~of~}  J/\psi \rm{~after ~leg }~\it{p}_{\rm{T}} \rm{~and }~\eta\rm{ ~cuts~ in} ~|\it{y}|~ <~\rm{0.9}}
...
\begin{enumerate}
  \item 
  	The events which contain dielectron candidates are stored in the event pools. 
